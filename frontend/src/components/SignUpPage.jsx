...
export default function SignUpPage({ onSignUp, onSwitchToLogin, authError }) {
  ...
  return (
    <div className="bg-slate-900 flex items-center justify-center min-h-screen">
      <div className="bg-slate-800 p-8 rounded-xl shadow-lg w-full max-w-sm">
        <h1 className="text-3xl font-bold text-center text-cyan-400 mb-2">Create Account</h1>
        <p className="text-center text-slate-400 mb-8">Join AarogyaAI Portal</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {authError && <p className="text-red-400 text-xs italic mb-4">{authError}</p>}
