    ...
    return (
        <div className="space-y-8">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
                <h2 className="text-xl font-semibold text-gray-800 mb-4 uppercase tracking-wider">Live Outbreak Heatmap</h2>
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <aside className="lg:col-span-1 space-y-4">
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-3 mt-2">
                               {Object.keys(mockData).map(key => (
                                    <button key={key} onClick={() => setActiveDisease(key)} 
                                        className={`p-3 text-sm font-bold rounded-lg shadow-sm transition-all duration-200 border-2 flex items-center justify-center ${activeDisease === key ? `bg-${mockData[key].color}-500 text-white border-${mockData[key].color}-700` : 'bg-slate-50 text-slate-800 hover:bg-slate-100 border-transparent'}`}>
                                        {mockData[key].name}
                                    </button>
                               ))}
                            </div>
                         ...
                         <div>
                            <label htmlFor="intensity" className="text-sm font-semibold text-slate-500 block uppercase tracking-wider">Radius</label>
                        ...
                        <div>
                            <label htmlFor="blur" className="text-sm font-semibold text-slate-500 block uppercase tracking-wider">Blur</label>
